    ...
    <div className="container py-2">
      <div className="row justify-content-center">
        <div className="col-12 col-md-8 text-center">
          ...
          <h1 className="display-5 text-dark">Cảm ơn bạn đã mua hàng!</h1>
          <p className="lead mt-3 text-dark">
            Đơn hàng của bạn đã được đặt thành công và đang được xử lý. Bạn sẽ
            sớm nhận được email xác nhận kèm theo chi tiết đơn hàng.
          </p>
